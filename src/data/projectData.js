export const ProjectData = [
    ...
    },
    {
        ...
        title: "GIPHY Search",
        about:
            "A web-based application which allows users to retrieve an array of GIFs from GIPHY. It allows users to navigate to the original source on GIPHY or copy the URL to the user's clipboard. The purpose of this project was to implement an existing web API and to fetch data into an existing program.",
        tags: [
            "React", "JavaScript", "HTML", "CSS", "SASS"
        ],
        demo: "https://giphy-search-me.netlify.app",
        github: "https://github.com/helexander/GIPHYSearch",
        imageStatic: require('../assets/project_img/project-4.png').default,
    },
    {
        id: 6,
